// ============================================================================
// Archivo: OccupationController.cs
// Proyecto: RH365.WebMVC
// Ruta: RH365/Controllers/OccupationController.cs
// ============================================================================
...
namespace RH365.Controllers
{
    public class OccupationController : Controller
    {
        ...
        public OccupationController(IUserContext userContext, ILogger<OccupationController> logger)
        {
        ...
        [HttpGet]
        public IActionResult LP_Occupations()
        {
            ...
            return View("~/Views/Occupation/LP_Occupations.cshtml");
        }
        ...
        public IActionResult NewEdit(long? recId = null)
        {
            ...
            return View("~/Views/Occupation/NewEdit_Occupation.cshtml");
        }
    }
}
