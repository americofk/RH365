...
(function () {
    ...
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['RecID', 'CountryCode', 'Name', 'NationalityCode', 'NationalityName', 'CreatedOn'];
    ...
    const deleteCountry = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('País(es) eliminado(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar país(es)', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=countries-dt.js.map