...
class LoginManager {
    ...
    showFieldError(input, message) {
        ...
        let errorElement = (_a = input.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('.invalid-feedback');
        if (!errorElement) {
            errorElement = document.createElement('div');
            errorElement.className = 'invalid-feedback';
            (_b = input.parentElement) === null || _b === void 0 ? void 0 : _b.appendChild(errorElement);
        }
    ...
    clearFieldError(input) {
        ...
        const errorElement = (_a = input.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('.invalid-feedback');
        if (errorElement) {
            errorElement.remove();
        }
    }
    ...
    showError(message) {
        ...
        if (!alertElement) {
            ...
            `;
            (_a = this.elements.form.parentElement) === null || _a === void 0 ? void 0 : _a.insertBefore(alertElement, this.elements.form);
        }
        else {
