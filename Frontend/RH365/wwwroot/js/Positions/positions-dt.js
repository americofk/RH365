...
(function () {
    ...
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['ID', 'PositionCode', 'PositionName', 'IsVacant', 'PositionStatus', 'StartDate', 'CreatedOn'];
    ...
    const deletePosition = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Posición(es) eliminada(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar posición(es)', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=positions-dt.js.map