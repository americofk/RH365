...
(function () {
    ...
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['OccupationCode', 'Description', 'CreatedOn', 'ModifiedOn'];
    ...
    const loadOccupations = () => __awaiter(this, void 0, void 0, function* () {
    ...
    const deleteOccupation = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Ocupación(es) eliminada(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar ocupación(es)', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=occupations-dt.js.map