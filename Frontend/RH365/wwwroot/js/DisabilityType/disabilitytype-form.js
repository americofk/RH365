...
(function () {
     ...
     */
    const loadDisabilityTypeData = () => __awaiter(this, void 0, void 0, function* () {
        if (isNew) {
        ...
        try {
            ...
            disabilityTypeData = yield fetchJson(url);
            ...
            w.ALERTS.error('Error al cargar los datos del tipo de discapacidad', 'Error');
     ...
     */
    const saveDisabilityType = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            w.ALERTS.ok(isNew ? 'Tipo de discapacidad creado exitosamente' : 'Tipo de discapacidad actualizado exitosamente', 'Éxito');
    ...
    $('#btn-save').on('click', () => __awaiter(this, void 0, void 0, function* () {
        const form = document.getElementById('frm-disabilitytype');
...
//# sourceMappingURL=disabilitytype-form.js.map