...
(function () {
    ...
    const $table = $("#disabilitytypes-table");
    if (!$table.length)
        return;
    let disabilityTypesData = [];
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['DisabilityTypeCode', 'Description', 'CreatedOn'];
    ...
    const loadDisabilityTypes = () => __awaiter(this, void 0, void 0, function* () {
    ...
    const deleteDisabilityType = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Tipo(s) de discapacidad eliminado(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar tipo(s) de discapacidad', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=disabilitytypes-dt.js.map