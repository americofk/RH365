...
(function () {
    ...
    const $table = $("#calendar-holidays-table");
    if (!$table.length)
        return;
    let calendarHolidaysData = [];
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['ID', 'CalendarDate', 'Description', 'Observations', 'CreatedOn'];
    ...
    const loadCalendarHolidays = () => __awaiter(this, void 0, void 0, function* () {
    ...
    const deleteCalendarHoliday = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Día(s) feriado(s) eliminado(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar día(s) feriado(s)', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=calendar-holidays-dt.js.map