...
(function () {
     ...
     */
    const loadCourseTypeData = () => __awaiter(this, void 0, void 0, function* () {
        if (isNew) {
     ...
     */
    const saveCourseType = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            w.ALERTS.ok(isNew ? 'Tipo de curso creado exitosamente' : 'Tipo de curso actualizado exitosamente', 'Éxito');
    ...
    $('#btn-save').on('click', () => __awaiter(this, void 0, void 0, function* () {
        const form = document.getElementById('frm-coursetype');
...
//# sourceMappingURL=coursetype-form.js.map