...
(function () {
    ...
    const $table = $("#coursetypes-table");
    if (!$table.length)
        return;
    let courseTypesData = [];
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['ID', 'CourseTypeCode', 'Name', 'Description', 'CreatedOn'];
    ...
    const deleteCourseType = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Tipo(s) de curso eliminado(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar tipo(s) de curso', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=coursetypes-dt.js.map