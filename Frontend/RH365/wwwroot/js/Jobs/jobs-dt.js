...
(function () {
    ...
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['RecID', 'JobCode', 'Name', 'JobStatus', 'CreatedOn'];
    ...
    const deleteJob = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Cargo(s) eliminado(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar cargo(s)', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=jobs-dt.js.map