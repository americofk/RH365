...
(function () {
    ...
    const $table = $("#classrooms-table");
    if (!$table.length)
        return;
    let classRoomsData = [];
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['ID', 'ClassRoomCode', 'Name', 'MaxStudentQty', 'AvailableTimeStart', 'CreatedOn'];
    ...
    const loadCourseLocations = () => __awaiter(this, void 0, void 0, function* () {
        try {
    ...
    const deleteClassRoom = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Salón(es) de clases eliminado(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar salón(es) de clases', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=class-rooms-dt.js.map