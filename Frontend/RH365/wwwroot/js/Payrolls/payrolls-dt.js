...
(function () {
    ...
    const $table = $("#payrolls-table");
    if (!$table.length)
        return;
    let payrollsData = [];
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['ID', 'Name', 'PayFrecuencyName', 'ValidFrom', 'ValidTo', 'PayrollStatus', 'CreatedOn'];
    let gridViewsManager;
    let gridColumnsManager;
    // Mapa de frecuencias de pago según GlobalsEnum
    const payFrecuencyMap = {
        0: 'Diario',
        1: 'Semanal',
        2: 'Bisemanal',
        3: 'Quincenal',
    ...
    const enrichPayrollData = (payrolls) => {
        return payrolls.map(payroll => {
            const enriched = Object.assign({}, payroll);
    ...
    const loadPayrolls = () => __awaiter(this, void 0, void 0, function* () {
    ...
    const deletePayroll = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Nómina(s) eliminada(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar nómina(s)', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=payrolls-dt.js.map