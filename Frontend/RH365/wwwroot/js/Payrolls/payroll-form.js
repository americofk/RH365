...
(function () {
    ...
    // ========================================================================
    const loadPayrollData = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            payrollData = yield fetchJson(url);
            renderBusinessForm(payrollData);
            renderAuditForm(payrollData);
        }
        catch (error) {
            w.ALERTS.error('Error al cargar los datos de la nómina', 'Error');
            renderBusinessForm({});
            renderAuditForm({});
        }
    });
    ...
    // GUARDADO DE NÓMINA
    // ========================================================================
    const savePayroll = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            w.ALERTS.ok(isNew ? 'Nómina creada exitosamente' : 'Nómina actualizada exitosamente', 'Éxito');
            //setTimeout(() => {
    ...
    $('#btn-save').on('click', () => __awaiter(this, void 0, void 0, function* () {
        const form = document.getElementById('frm-payroll');
...
//# sourceMappingURL=payroll-form.js.map