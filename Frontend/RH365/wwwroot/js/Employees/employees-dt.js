...
// Est�ndar: ISO 27001 - Trazabilidad de consultas y accesos
// ============================================================================
...
(function () {
    ...
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['EmployeeCode', 'Name', 'LastName', 'Gender', 'MaritalStatus', 'EmployeeStatus', 'AdmissionDate'];
    ...
    const titleize = (field) => {
        const translations = {
            ...
            'PayMethod': 'M�todo Pago',
            'WorkStatus': 'Estado Laboral',
            'EmployeeAction': 'Acci�n',
    ...
    const getWorkStatusLabel = (value) => {
        const statusMap = {
    ...
    const initializeDataTable = (columns) => {
        ...
        const dtConfig = {
            ...
            language: {
                ...
                search: 'Buscar:',
                paginate: { first: 'Primera', last: '�ltima', next: 'Siguiente', previous: 'Anterior' },
    ...
    const loadEmployees = () => __awaiter(this, void 0, void 0, function* () {
    ...
    const deleteEmployee = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const message = count === 1
            ? '�Est� seguro de eliminar este empleado?'
            : `�Est� seguro de eliminar ${count} empleados?`;
        w.ALERTS.confirm(message, 'Confirmar Eliminaci�n', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Empleado(s) eliminado(s) correctamente', '�xito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar empleado(s)', 'Error');
            }
        }), { type: 'danger' });
    }));
    $('#btn-export').on('click', exportToCSV);
    $('#btn-import').on('click', () => {
        w.ALERTS.info('Funcionalidad de importaci�n pr�ximamente', 'Informaci�n');
    });
...
//# sourceMappingURL=employees-dt.js.map