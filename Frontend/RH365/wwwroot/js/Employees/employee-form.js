...
(function () {
    ...
    let recId = parseInt(pageContainer.getAttribute("data-recid") || "0", 10);
    let isNew = pageContainer.getAttribute("data-isnew") === "true";
    /**
     ...
     */
    const getEmployeeStatusOptions = () => {
        return [
     ...
     */
    const renderField = (config, value, layoutType) => {
     ...
     */
    const loadEmployeeData = () => __awaiter(this, void 0, void 0, function* () {
        if (isNew) {
        ...
        try {
            ...
            employeeData = yield fetchJson(url);
            ...
            w.ALERTS.error('Error al cargar los datos del empleado', 'Error');
     ...
     */
    const saveEmployee = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            w.ALERTS.ok(isNew ? 'Empleado creado exitosamente' : 'Empleado actualizado exitosamente', 'Exito');
    ...
    $('#btn-save').on('click', () => __awaiter(this, void 0, void 0, function* () {
        const form = document.getElementById('frm-employee');
...
//# sourceMappingURL=employee-form.js.map