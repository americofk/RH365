...
(function () {
    ...
    const $table = $("#employee-addresses-table");
    if (!$table.length)
        return;
    let addressesData = [];
    ...
    // CARGA DE DATOS
    // ========================================================================
    const loadAddresses = () => __awaiter(this, void 0, void 0, function* () {
        if (isNew) {
            return [];
        }
        try {
            ...
            const filteredAddresses = allAddresses.filter((address) => address.EmployeeRefRecID === employeeRecId);
    ...
    const saveAddress = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            w.ALERTS.ok(recId > 0 ? 'Direccion actualizada exitosamente' : 'Direccion creada exitosamente', 'Exito');
            $('#modal-address').modal('hide');
            $table.DataTable().ajax.reload();
        }
        catch (error) {
            console.error('Error al guardar direccion:', error);
            w.ALERTS.error('Error al guardar la direccion', 'Error');
        }
    });
    const deleteAddress = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    // EVENT HANDLERS
    // ========================================================================
    $(document).on('ifChanged', '#check-all-addresses', function () {
    ...
    $('#btn-save-address').on('click', () => __awaiter(this, void 0, void 0, function* () {
        yield saveAddress();
    }));
    $('#btn-delete-address').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminacion', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Direccion(es) eliminada(s) correctamente', 'Exito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar direccion(es)', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=employee-addresses.js.map