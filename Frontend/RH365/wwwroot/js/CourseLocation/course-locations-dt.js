...
(function () {
    ...
    const $table = $("#courselocations-table");
    if (!$table.length)
        return;
    let courseLocationsData = [];
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['ID', 'CourseLocationCode', 'Name', 'Description', 'CreatedOn'];
    ...
    const deleteCourseLocation = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Ubicación(es) eliminada(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar ubicación(es)', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=course-locations-dt.js.map