...
(function () {
    ...
    // CARGA DE DATOS
    // ========================================================================
    const loadCourseLocationData = () => __awaiter(this, void 0, void 0, function* () {
        if (isNew) {
            renderBusinessForm({});
            renderAuditForm({});
            return;
        ...
        try {
            ...
            courseLocationData = yield fetchJson(url);
            renderBusinessForm(courseLocationData);
            renderAuditForm(courseLocationData);
        }
        catch (error) {
            w.ALERTS.error('Error al cargar los datos de la ubicación', 'Error');
            renderBusinessForm({});
            renderAuditForm({});
        }
    });
    ...
    // GUARDADO
    // ========================================================================
    const saveCourseLocation = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            w.ALERTS.ok(isNew ? 'Ubicación creada exitosamente' : 'Ubicación actualizada exitosamente', 'Éxito');
            setTimeout(() => {
    ...
    $('#btn-save').on('click', () => __awaiter(this, void 0, void 0, function* () {
        const form = document.getElementById('frm-courselocation');
        if (!form.checkValidity()) {
            form.reportValidity();
            return;
        }
        yield saveCourseLocation();
    }));
    // ========================================================================
    // INICIALIZACIÓN
    // ========================================================================
...
//# sourceMappingURL=course-location-form.js.map