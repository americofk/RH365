...
(function () {
    ...
    const $table = $("#earning-codes-table");
    if (!$table.length)
        return;
    let earningCodesData = [];
    let allColumns = [];
    let visibleColumns = [];
    const defaultColumns = ['ID', 'Name', 'Description', 'EarningCodeStatus', 'ValidFrom', 'ValidTo', 'IsTSS', 'IsISR', 'CreatedOn'];
    ...
    const loadEarningCodes = () => __awaiter(this, void 0, void 0, function* () {
    ...
    const deleteEarningCode = (recId) => __awaiter(this, void 0, void 0, function* () {
    ...
    $('#btn-delete').on('click', () => __awaiter(this, void 0, void 0, function* () {
        ...
        w.ALERTS.confirm(message, 'Confirmar Eliminación', (confirmed) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                w.ALERTS.ok('Código(s) de nómina eliminado(s) correctamente', 'Éxito');
                $table.DataTable().ajax.reload();
            }
            catch (error) {
                console.error('Error al eliminar:', error);
                w.ALERTS.error('Error al eliminar código(s) de nómina', 'Error');
            }
        }), { type: 'danger' });
    }));
...
//# sourceMappingURL=earning-codes-dt.js.map