// ============================================================================
// Archivo: CreateEmployeeContactInfoRequest.cs
// Proyecto: RH365.Core
// Ruta: RH365.Core/Domain/Models/EmployeeContactInfo/CreateEmployeeContactInfoRequest.cs
// Descripcion: Request para crear informacion de contacto de empleado
...
{
    /// <summary>
    /// Request para crear informacion de contacto de empleado
    /// Cumple con estandar ISO 27001 para validacion de datos
    /// </summary>
    public class CreateEmployeeContactInfoRequest
    {
        /// <summary>
        ...
        /// Campo opcional, por defecto false
        /// </summary>
