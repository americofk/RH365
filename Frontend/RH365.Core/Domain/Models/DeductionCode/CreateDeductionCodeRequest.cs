...
// Proyecto: RH365.Core
// Ruta: RH365.Core/Domain/Models/DeductionCode/CreateDeductionCodeRequest.cs
// Descripción: 
//   - Request para crear un código de deducción
//   - Cumplimiento ISO 27001: Validación de datos de entrada
//   - Incluye campos de negocio, configuración de contribución y deducción
// ============================================================================
...
{
    /// <summary>
    /// Modelo de request para creación de códigos de deducción
    /// Valida todos los campos requeridos según reglas de negocio
    /// </summary>
    public class CreateDeductionCodeRequest
    {
        ...
        [Required(ErrorMessage = "La acción de nómina es requerida")]
