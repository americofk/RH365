...
namespace D365_API_Nomina.Infrastructure.Migrations
{
    ...
    [Migration("20230414225901_des-108")]
    partial class des108
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.BatchHistory", b =>
                {
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.CalendarHoliday", b =>
                {
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.DeductionCodeVersion", b =>
                {
                    b.Property<int>("InternalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.DisabilityType", b =>
                {
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.EarningCodeVersion", b =>
                {
                    b.Property<int>("InternalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.EducationLevel", b =>
                {
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.EmployeeHistory", b =>
                {
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.EmployeeLoanHistory", b =>
                {
                    b.Property<int>("InternalId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.EmployeeTax", b =>
                {
                    ...
                    b.HasIndex("TaxId", "InCompany");

                    b.ToTable("EmployeeTaxes");
                });

            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.EmployeeWorkCalendar", b =>
                {
                    b.Property<int>("InternalId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.EmployeeWorkControlCalendar", b =>
                {
                    b.Property<int>("InternalId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.GeneralConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.Occupation", b =>
                {
                    b.Property<string>("OccupationId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.Province", b =>
                {
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.ReportConfig", b =>
                {
                    b.Property<int>("InternalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.TaxDetail", b =>
                {
                    ...
                    b.HasKey("InternalId", "TaxId", "InCompany");
            ...
            modelBuilder.Entity("D365_API_Nomina.Core.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("D365_API_Nomina.Core.Domain.Entities.DisabilityType", null)
                        .WithMany()
                        .HasForeignKey("DisabilityTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("D365_API_Nomina.Core.Domain.Entities.EducationLevel", null)
                        .WithMany()
                        .HasForeignKey("EducationLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("D365_API_Nomina.Core.Domain.Entities.Occupation", null)
                        .WithMany()
