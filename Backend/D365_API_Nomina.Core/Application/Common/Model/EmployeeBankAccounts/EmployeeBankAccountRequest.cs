...
namespace D365_API_Nomina.Core.Application.Common.Model.EmployeeBankAccounts
{
    public class EmployeeBankAccountRequest : GenericValidation<EmployeeBankAccountRequest>, IValidatableObject
    {
