...
namespace D365_API_Nomina.Core.Application.Common.Model.EmployeeWorkControlCalendars
{
    public class EmployeeWorkControlCalendarRequest: GenericValidation<EmployeeWorkControlCalendarRequest>, IValidatableObject
    {
