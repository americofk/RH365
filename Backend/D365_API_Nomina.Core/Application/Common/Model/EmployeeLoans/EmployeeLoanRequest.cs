...
{
    public class EmployeeLoanRequest : GenericValidation<EmployeeLoanRequest>, IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            List<ValidationResult> validationResults = new List<ValidationResult>()
            {
                ...
                ForRule(this, x => x.QtyPeriodForPaid == 0, "La frecuencia de pago no puede ser 0"),
                ForRule(this, x => x.StartPeriodForPaid == 0, "El período de inicio no puede estar vacío"),
            };
