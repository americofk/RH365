// ============================================================================
// Archivo: CreateEmployeeLoanHistoryRequest.cs
// Proyecto: RH365.Core
// Ruta: RH365.Core/Application/Features/DTOs/EmployeeLoanHistory/CreateEmployeeLoanHistoryRequest.cs
// Descripción:
//   - DTO de creación para EmployeeLoanHistory
...
{
    /// <summary>
    /// Payload para crear un registro de historial de préstamo.
    /// </summary>
    public class CreateEmployeeLoanHistoryRequest
    {
